...
export default function GithubIcon({ color1 = "#007AB9", color2 = "#F1F2F2" }) {
  return (
    <svg
      version="1.1"
      id="Capa_1"
      ...
      x="0px"
      y="0px"
      viewBox="5 5 430.5 430.5"
      style={{ enableBackground: "new 0 0 438.5 438.5" }}
      xmlSpace="preserve"
    >
      <g>
        <circle
        ...
        <path
          style={{ fill: color1 }}
          class="st0"
          d="M409.1,114.6c-19.6-33.6-46.2-60.2-79.8-79.8C295.7,15.2,259.1,5.4,219.3,5.4c-39.8,0-76.5,9.8-110.1,29.4

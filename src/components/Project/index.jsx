...
// Constants
import {
  HERO_SECTION_PROJECTS_CARD_BUTTON,
  HERO_SECTION_PROJECTS_CARD_BUTTON_HOVER,
  HERO_SECTION_PROJECTS_CARD_HEADER,
...
const Title = styled.h3`
  color: ${HERO_SECTION_PROJECTS_CARD_HEADER};
...
const GitHub = styled.a`
  ...
  color: #f9f9f9;
  background-color: ${HERO_SECTION_PROJECTS_CARD_BUTTON};
  padding: 0.5em 1em;

  &:hover {
    color: #f9f9f9;
    background-color: ${HERO_SECTION_PROJECTS_CARD_BUTTON_HOVER};
  }
`;
const Demo = styled.a`
  text-decoration: none;
